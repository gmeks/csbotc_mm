...
OBJECTS = CSBotControl.cpp cvars.cpp SharedFunctions.cpp Menu.cpp \
	hl2sdk/bitbuf.cpp hl2sdk/networkvar.cpp hl2sdk/convar.cpp hl2sdk/recipientfilters.cpp \
	hl2sdk/utlbuffer.cpp hl2sdk/KeyValues.cpp BATMenu.cpp
